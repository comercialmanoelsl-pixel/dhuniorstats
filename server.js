...
const SM_AUDIT_INCLUDES = [
  ...
  "formations","coaches","sidelined","odds","metadata"
];
...
app.get("/api/sportmonks-raw", async (req,res)=>{
  try{
    ...
    const includeSets = {
      ...
      extra:"formations;coaches;sidelined;odds;metadata",
      all:"participants;scores;state;league;season;venue;periods;events;events.type;events.participant;statistics;statistics.type;lineups;lineups.player;lineups.position;lineups.type;formations;coaches;sidelined;odds;metadata"
    };
