...
## V35.1 Lineups SofaScore Fix
- Campo horizontal estilo SofaScore.
- Mandante sempre à esquerda.
- Visitante sempre à direita.
- Jogadores não misturam mais no meio.
- Deduplicação de jogadores repetidos.
- Lateral de escalações organizada por time.
- Menos sobreposição e labels menores.
